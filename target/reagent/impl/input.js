...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__1341){
var map__1342 = p__1341;
var map__1342__$1 = cljs.core.__destructure_map.call(null,map__1342);
var on_write = cljs.core.get.call(null,map__1342__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__4160__auto__ = (!((((node === document.activeElement)) && (reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (typeof rendered_value === 'string') && (typeof dom_value === 'string'))));
if(or__4160__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__1343 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__1344 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__1344);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__1343);
}}));
} else {
...
(jsprops.onChange = (function (p1__1345_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__1345_SHARP_);
}));
